...
public class Itinerary {
    ...
    public String toString() {
        return "Itinerary [originPlace=" + originPlace + ", destinationPlace=" + destinationPlace
                + ", departureDateTime=" + departureDateTime + ", arrivalDateTime=" + arrivalDateTime
                + ", carriers=" + carriers + ", legs=" + legs + ", agents=" + agents + ", price=" + price
                + ", deeplink=" + deeplink + ", userId=" + userId + ", id=" + id + "]";
    }
